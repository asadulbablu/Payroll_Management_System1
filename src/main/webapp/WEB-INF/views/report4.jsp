                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Loan Report</h4></div>
                                <div class="inner-block">
                                    <form:form method="POST" action="reportView4" commandName="report4InputForm">



                                        <div align="center">  <form:button  type="submit"  class="btn btn-success">Employee Loan</form:button></div>
