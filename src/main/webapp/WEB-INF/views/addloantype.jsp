                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Loan Type</h4></div>
                                <c:if test="${check}">
                                    <form:form name="addloantypeObject"
                                               modelAttribute="addloantypeObject1" action="addingloantype"
                                               method="post">
                                        <div class="form-group">
                                            <form:input class="form-control"
                                                        Placeholder="Loan Type Id" type="text" path="loantypeid" required="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                            <form:input class="form-control"
                                                        Placeholder="Loan Description" type="text" path="loandescription" required="true"></form:input>
                                            </div>

                                        <form:button id="editbuttons" type="submit" name="Addloantype"
                                                     class="btn btn-success">Add LoanType</form:button>
                                    ...
                                    <form:form name="addloantypeObject"
                                        ...
                                        <div class="form-group">
                                            <form:input id="name" class="form-control"
                                                        Placeholder="Loan type Id" type="text" path="loantypeid" readonly="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                            <form:input id="name" class="form-control"
                                                        Placeholder="Loan Description" type="text" path="loandescription"></form:input>
                                            </div>

                                        <form:button id="editbuttons" type="submit" name="Editloantype"
                                                     class="btn btn-success">Edit LoanType</form:button>
                                        <form:button id="removebuttons" type="reset" class="btn btn-info">Reset
                                            Details</form:button>
                                    </form:form>
                                </c:if>
                        ...
                        <div class="chit-chat-layer1">
                            <div class="card-body" >
                                <span class="lead">List Of Loan Type</span>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="Cat in Catagory">
                                                ...
                                                <td>{{Cat.loantypeid}}</td>
                                                <td>{{Cat.loandescription}}</td>
                                                <td><a href="editloantypebutton?getcid={{Cat.loantypeid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removeloantype/{{Cat.loantypeid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
