                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Basic Year</h4></div>
                                <c:if test="${check}">
                                    <form:form name="addbasicyearobject"
                                               modelAttribute="addbasicyearobject1" action="addingbasicyear"
                                               method="post">
                                        <div class="form-group">
                                            <form:input class="form-control"
                                                        Placeholder="BasicYear Id" type="text" path="yearid" required="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                            <form:input class="form-control"
                                                        Placeholder="BasicYear Name" type="text" path="year" required="true"></form:input>
                                            </div>

                                        <form:button id="editbuttons" type="submit" name="Addbasicyear"
                                                     class="btn btn-success">Add BasicYear</form:button>
                                    ...
                                    <form:form name="addbasicyearobject"
                                        ...
                                        <div class="form-group">
                                            <form:input id="name" class="form-control"
                                                        Placeholder="BasicYear Id" type="text" path="yearid" readonly="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                            <form:input id="name" class="form-control"
                                                        Placeholder="BasicYear Name" type="text" path="year"></form:input>
                                            </div>

                                        <form:button id="editbuttons" type="submit" name="Editbasicyear"
                                                     class="btn btn-success">Edit Basic Year</form:button>
                        ...
                        <div class="chit-chat-layer1">
                            <div class="card-body" >
                                <span class="lead">List Of Basic Year</span>
                                <div class="table-responsive"  ng-app="myapp"
                                     ng-controller="CategoryController" width="100%">
<!--                                    <div class="pagetitle" align="center"><h4> Basic Year List</h4></div>-->
                                    <p><input type="text" ng-model="test" class="form-control" placeholder="Search basic year"></p>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>Basic Year Id </th>
                                                <th>Basic Year Name</th>

                                            </tr>
                                        </thead>

                                        <tbody>
                                            <tr ng-repeat="Cat in Catagory | filter:test">

                                                <td>{{Cat.yearid}}</td>
                                                <td>{{Cat.year}}</td>
                                                <td><a href="editbasicyearbutton?getcid={{Cat.yearid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removebasicyear/{{Cat.yearid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
