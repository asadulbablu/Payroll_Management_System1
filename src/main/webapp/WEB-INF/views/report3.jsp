                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Monthly Salary Report of Total Employee</h4></div>
                                <div class="inner-block">
                                    <form:form method="POST" action="reportView3" commandName="report3InputForm">



                                        <div align="center">  <form:button  type="submit"  class="btn btn-success">Search-NetSalary</form:button></div> 
