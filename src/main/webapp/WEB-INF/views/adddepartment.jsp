...
<!--market updates updates-->
	 <div class="market-updates"><div class="pagetitle" align="center"><h4>Add Department</h4></div>
                            ...
                            <form:form name="addCategoryObject"
                                ...
                                <div class="form-group">
                                    <form:input class="form-control"
                                                Placeholder="Department Id" type="text" path="deptid" required="true"></form:input>
                                    </div>
                                    <div class="form-group">
                                    <form:input class="form-control"
                                                Placeholder="Department Name" type="text" path="deptname" required="true"></form:input>
                                    </div>
                                    
                                <form:button class="btn btn-success" id="editbuttons" type="submit" name="Addcategory"
                            ...
                            <form:form name="addCategoryObject"
                                ...
                                <div class="form-group">
                                    <form:input id="name" class="form-control"
                                                Placeholder="Category Id" type="text" path="deptid" readonly="true"></form:input>
                                    </div>
                                    <div class="form-group">
                                    <form:input id="name" class="form-control"
                                                Placeholder="Category Name" type="text" path="deptname"></form:input>
                                    </div>
                                    
                                <form:button id="editbuttons" type="submit" name="EditCategory"
                                             class="btn btn-success">Edit Department</form:button>
...
<div class="chit-chat-layer1">
	<div class="card-body" >
            <span class="lead">List Of Department</span>
                                <div class="table-responsive"  ng-app="myApp"
                     ng-controller="CategoryController" width="100%">
                                    <p><input type="text" ng-model="test" class="form-control" placeholder="Search department"></p>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="depart in dpt | filter:test">
                                               
                                                <td>{{depart.deptid}}</td>
                                                <td>{{depart.deptname}}</td>
                                                <td><a href="editdeptbutton?getcid={{depart.deptid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removedepartment/{{depart.deptid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
