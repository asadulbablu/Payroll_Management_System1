...
<html>
    <head>
        ...
        var basicyearlist = ${basicyearlist};

        angular.module('organocartpackage', []).controller('ProductController',
                function ($scope) {
                    $scope.job = jobtitlelist;
                    $scope.basic = basicyearlist;
                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Job Title</h4></div>
                                <form:form commandName="newjobtitleObject" action="addingjobtitle"
                                           enctype="multipart/form-data">
                                    <c:if test="${check}">
                                        <div class="form-group">

                                            <form:input class="form-control" Placeholder="JobTitle Id"
                                                        type="text" path="jobtitleid" required="true"></form:input>
                                            </div>
                                    </c:if>
                                    <c:if test="${!check}">
                                        <div class="form-group">
                                            <form:input class="form-control" Placeholder="JobTitle Id"
                                                        type="text" path="jobtitleid" readonly="true" required="true"></form:input>
                                            </div>
                                    </c:if>
                                    <div class="form-group">
                                        ...
                                        <form:input type="number" class="form-control"
                                                    placeholder="Basic Salary" path="basicsalary" required="true"></form:input>
                                        </div>


                                        <div class="form-group">
                                            <select class="form-control" ng-model="selectedSup" ng-options="x.year for x in basic">
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        <form:hidden  class="form-control" value="{{selectedSup.yearid}}" path="yearid"></form:hidden>
                                        </div>
                        ...
                        <div class="chit-chat-layer1">
                            <div class="card-body" >
                                <span class="lead">List Of Job Title</span>
                                <div width="100%">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="bsc in job">

                                                <td>{{bsc.jobtitleid}}</td>
                                                <td>{{bsc.jobtitle}}</td>
                                                <td>{{bsc.basicsalary}}</td>
                                                <td>{{bsc.yearid}}</td>
                                                <td><a href="editjobtitle?getpid={{bsc.jobtitleid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removingjobtitle/{{bsc.jobtitleid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
