...
<!--market updates updates-->
	 <div class="market-updates">
			<div class="formcontainer">
                            <div class="pagetitle" align="center"><h4>Add Allowance</h4></div>
                       <c:if test="${check}">
                            <form:form name="addallowanceobject"
                                       modelAttribute="addallowanceobject1" action="addingallowance"
                                       method="post">
                                <div class="form-group">
                                    <form:input class="form-control"
                                                Placeholder="Allowance Id" type="text" path="allowanceid" required="true"></form:input>
                                    </div>
                                    <div class="form-group">
                                    <form:input class="form-control"
                                                Placeholder="Allowance Head" type="text" path="allowancehead" required="true"></form:input>
                                    </div>
                                    
                                <form:button id="editbuttons" type="submit" name="Addallowance"
                                             class="btn btn-success">Add Allowance</form:button>
                            ...
                            <form:form name="addallowanceobject"
                                ...
                                <div class="form-group">
                                    <form:input id="name" class="form-control"
                                                Placeholder="Allowance Id" type="text" path="allowanceid" readonly="true"></form:input>
                                    </div>
                                    <div class="form-group">
                                    <form:input id="name" class="form-control"
                                                Placeholder="Allowance Head" type="text" path="allowancehead"></form:input>
                                    </div>
                                    
                                <form:button id="editbuttons" type="submit" name="Editallowance"
                                             class="btn">Edit Allowance</form:button>
...
<div class="chit-chat-layer1">
	<div class="card-body" >
            <span class="lead">List Of Allowance</span>
            
                                <div class="table-responsive"  ng-app="myapp"
                     ng-controller="CategoryController" width="100%">
                                    <p><input type="text" ng-model="test" class="form-control" placeholder="Search allowance"></p>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="allow in Catagory| filter:test">
                                               
                                                <td>{{allow.allowanceid}}</td>
                                                <td>{{allow.allowancehead}}</td>
                                                <td><a href="editallowancebutton?getcid={{allow.allowanceid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removeallowance/{{allow.allowanceid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
