        ...
        <div class="page-container">	
            <div class="left-content">
                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Net Salary</h4></div>
                ...
                <div class="chit-chat-layer1">
                    <div class="card-body" >
                        <span class="lead">List Of Net Salary</span>
                        ...
                        <div width="100%">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr ng-repeat="bsc in nsal | filter:test">

                                        <td>{{bsc.netsalaryid}}</td>
                                        <td>{{bsc.empid}}</td>
                                        <td>{{bsc.empname}}</td>
                                        <td>{{bsc.basicsalary}}</td>
                                        <td>{{bsc.totalallowpermonth}}</td>
                                        <td>{{bsc.totaldeductpermonth}}</td>
                                        <td>{{bsc.netsalary}}</td>
