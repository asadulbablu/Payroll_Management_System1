                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Employee</h4></div>
                        ...
                        <div class="chit-chat-layer1">
                            <div class="card-body" >
                                ...
                                <p><input type="text" ng-model="test" class="form-control" placeholder="Search employee"></p>
                                <div width="100%">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="eml in empl | filter:test">
                                                ...
                                                <td>{{eml.typeid}}</td>
                                                <td>{{eml.deptid}}</td>
                                                <td>{{eml.jobtitleid}}</td>
                                                <td><img style="width:10px ;height:20px" src="resources/pimage/{{emp.empid}}.jpg" />
                                                </td>
                                                <td><a href="editempinfo?getpid={{eml.empid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removingempinfo/{{eml.empid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
