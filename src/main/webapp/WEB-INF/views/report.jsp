                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                               <div class="pagetitle" align="center"><h4>Monthly Salary of One Employee</h4></div>
                                        ...
                                        <table id="reptbl" width="350px" border="1">
                                            ...
                                            <div class="form-group">
                                                <div class="form-label-group">
                                                    <form:input class="form-control"  type="text" path="eid" required="true" id="eid"></form:input>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-label-group">
                                                    <form:input class="form-control"  type="text" path="ename" required="true" id="ename"></form:input>
                                                        <label for="ename">Emp_Name</label>
                                                    </div>
                                                </div>


                                            <form:button  type="submit"  class="btn btn-success">Search-NetSalary</form:button>
