...
<html>
    <head>
        ...
        <script>
        var paylist = ${paymentlist};
        var emplist = ${emplist};
        var ptypelist = ${paytypelist};
        var byearlist = ${basicyearlist};
        var nslist = ${nslist};
        angular.module('organocartpackage', []).controller('ProductController',
                function ($scope) {
                $scope.pay = paylist;
                $scope.emp = emplist;
                $scope.ptype = ptypelist;
                $scope.basic = byearlist;
                $scope.nsl = nslist;
                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Payment</h4></div>
                                <form:form commandName="paymentObject" action="addingpayment"
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" ng-model="selectedSup" ng-options="e.empname for e in emp">
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <form:input class="form-control" Placeholder="payment Date"
                                                    type="text" path="paymentdate" required="true"></form:input>
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control" ng-model="selectedSup1" ng-options="p.paymenttypename for p in ptype">
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        <form:hidden  class="form-control" value="{{selectedSup1.paymenttypeid}}" path="paymenttypeid"></form:hidden>
                                        </div>
                                        <div class="form-group">
                                        <form:input type="text" class="form-control"
                                                    placeholder="Cheque No" path="chequeno" ></form:input>
                                        </div>
                                        <div class="form-group">
                                        <form:input type="text" class="form-control"
                                                    placeholder="Bank Name" path="bank" ></form:input>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" ng-model="selectedSup2" ng-options="b.year for b in basic">
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <form:hidden  class="form-control" value="{{selectedSup2.yearid}}" path="yearid"></form:hidden>
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control" ng-model="select" ng-options="p.netsalary for p in nsl">
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        <form:input type="number" class="form-control"
                                                    value="{{select.netsalary}}" path="netsalary" ></form:input>
                                        </div>
                                    <c:if test="${check}">
                        ...
                        <div class="chit-chat-layer1">
                            <div class="card-body" >
                                <span class="lead">List Of Payment</span>
                                ...
                                <div width="100%">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="p in pay | filter:test">
                                                ...
                                                <td><a href="editpaymentpage?getpid={{p.paymentid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removingpayment/{{p.paymentid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
