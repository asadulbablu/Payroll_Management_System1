                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                               <div class="pagetitle" align="center"><h4> Employee Payment History</h4></div>

                                <div class="inner-block">
                                    <form:form method="POST" action="reportView5" commandName="report5InputForm">

                                        <table id="reptbl" width="350px" border="1">

                                            <div class="form-group">
                                                <div class="form-label-group">
                                                    <form:input class="form-control"  type="text" path="empid" required="true" id="eid"></form:input>
                                                        <label for="eid">Emp_Id</label>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <div class="form-label-group">
                                                    <form:input class="form-control"  type="text" path="empname" required="true" id="ename"></form:input>
                                                        <label for="ename">Emp_Name</label>
                                                    </div>
                                                </div>


                                            <form:button  type="submit"  class="btn btn-success">Search-Payment History</form:button>
