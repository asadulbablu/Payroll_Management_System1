...
<html>
    <head>
        <title>Deduction Calculation Page</title>
        ...
        <script>
        var jdeductcallist = ${jdeductcallist};
        var jtitlelist = ${jtitlelist};
        var deductlist = ${deductionlist};
        var emplist = ${emplist};
        var cartproductlist = ${itemsincart};
        angular.module('organocartpackage', []).controller('ProductController',
                function ($scope) {
                $scope.jdcl = jdeductcallist;
                $scope.jtl = jtitlelist;
                $scope.deductl = deductlist;
                $scope.emp = emplist;
                $scope.citems = cartproductlist;
                console.log($scope.jtl);
                console.log($scope.deductl);
                });
        </script>
                ...
                <div class="mother-grid-inner">
                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Deduction Calculation</h4></div>
                                <form:form commandName="paydeductcalObject" action="addtocart"
                                           enctype="multipart/form-data">


                                    <div class="form-group">
                                        <select class="form-control" ng-model="did" ng-options="x.deductionhead for x in deductl" required="true">
                                            <option value="">-- Deduction Head --</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <form:hidden  class="form-control"  path="jobdeductcalid" value="{{did.deductionid}}" ></form:hidden>
                                        </div>

                                        <div class="form-group">
                                        <form:hidden  class="form-control" value="{{did.deductionid}}" path="deductionid"></form:hidden>
                                        </div>

                                        <div class="form-group">
                                        <form:input type="text" class="form-control"  path="deductionhead" value="{{did.deductionhead}}" required="true"></form:input>
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control" ng-model="tit" ng-options="x.basicsalary for x in jtl" required="true">
                                                <option value="">-- Basic salary --</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        <form:hidden  class="form-control" value="{{tit.jobtitleid}}" path="jobtitleid"></form:hidden>
                                        </div>
                                        <div class="form-group">
                                        <form:input type="number" class="form-control"  path="basicsalary" value="{{tit.basicsalary}}" required="true"></form:input>
                                        </div>
                                        <div class="form-group">
                                        <form:input type="number" class="form-control"  path="percent" Placeholder="percent" required="true"></form:input>
                                        </div>
                                    ...
                                    <table class="table table-striped table-responsive animated fadeInDown delay-05s">
                                        <thead>
                                            <tr scope="row">
                                                ...
                                                <th style="width: 10%">Deduction Id</th>
                                                <th style="width: 15%">Deduction Head</th>
                                                <th style="width: 7%">Basic salary</th>
                                                <th style="width: 7%">Percent</th>
                                                <th style="width: 7%">Deduction Amount </th>
                                        ...
                                        <tbody ng-repeat="items in citems">
                                            <tr scope="row" style="margin: 10px">
                                                ...
                                                <td class="h4">{{items.deductionid}}</td>
                                                <td>{{items.deductionhead}}</td>
                                                <td>Tk.{{items.basicsalary}}</td>
                                                <td>Tk.{{items.percent}}</td>
                                                <td>Tk.{{items.deductpermonth}}</td>
                                                <td><a href="removeproductitem?pid={{items.deductionid}}"
                    ...
                    <div class="panel-body">
                        <div class="formcontainer ">
                            ...
                            <form:form commandName="paydeductcalObject" action="addjobdeductcalpage"
                                       enctype="multipart/form-data">


                                <div class="form-group">
                                    <select class="form-control" ng-model="employee" ng-options="x.empname  for x in emp" required="true">
                                        <option value="">-- Emp Name --</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <form:hidden  class="form-control" value="{{employee.empid}}"  path="empid"></form:hidden>
                                    </div>

                                <c:if test="${check}">
                                    <form:button id="editbuttons" type="submit"  name="Add" class="btn btn-danger">Confirm
                                    </form:button>
                                    <form:button id="removebuttons" type="reset" class="btn btn-info">Reset
                                        Details</form:button>
                                </c:if>
