...
<html>
    <head>
        ...
        <script>
        var cat = ${paymenttypemodelobject};
        console.log(cat);
                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Payment Type</h4></div>
                                <c:if test="${check}">
                                    <form:form name="addpaymenttypeObject"
                                               modelAttribute="addpaymenttypeObject1" action="addingpaymenttype"
                                               method="post">
                                        <div class="form-group">
                                            <form:input class="form-control"
                                                        Placeholder="Payment Id" type="text" path="paymenttypeid" required="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                            <form:input class="form-control"
                                                        Placeholder="Payment Description" type="text" path="paymenttypename" required="true"></form:input>
                                            </div>

                                        <form:button id="editbuttons" type="submit" name="Addpaymenttype"
                                                     class="btn btn-success">Add PaymentType</form:button>
                                    ...
                                    <form:form name="addpaymenttypeObject"
                                        ...
                                        <div class="form-group">
                                            <form:input id="name" class="form-control"
                                                        Placeholder="Payment Id" type="text" path="paymenttypeid" readonly="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                            <form:input id="name" class="form-control"
                                                        Placeholder="Payment Description" type="text" path="paymenttypename"></form:input>
                                            </div>

                                        <form:button id="editbuttons" type="submit" name="Editpaymenttype"
                                                     class="btn btn-success">Edit Payment Type </form:button>
                        ...
                        <div class="chit-chat-layer1">
                            <div class="card-body" >
                                <span class="lead">List Of Payment Type</span>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="Cat in Catagory">
                                                ...
                                                <td>{{Cat.paymenttypeid}}</td>
                                                <td>{{Cat.paymenttypename}}</td>
                                                <td><a href="editpaymenttypebutton?getcid={{Cat.paymenttypeid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removepaymenttype/{{Cat.paymenttypeid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
