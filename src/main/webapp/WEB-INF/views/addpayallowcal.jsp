...
<html>
    <head>
        <title>Allowance Calculation Page</title>
        ...
        <script>
            var jallowcallist = ${jallowcallist};
            ...
            angular.module('organocartpackage', []).controller('ProductController',
                    function ($scope) {
                    $scope.jacl = jallowcallist;
                    $scope.jtl = jtitlelist;
                    $scope.allowl = allowlist;
                    $scope.emp = emplist;
                    $scope.citems = cartproductlist;
                    console.log($scope.jtl);
                    console.log($scope.jacl);
                    console.log($scope.allowl);
                ...
                <div class="mother-grid-inner">
                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Allowance Calculation</h4></div>
                                <form:form commandName="payallowcalObject" action="addtoallowance"
                                           enctype="multipart/form-data">

                                    <div class="form-group">
                                        <select class="form-control" ng-model="did" ng-options="x.allowancehead for x in allowl" required="true">
                                            <option value="">-- Allowance Head --</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <form:hidden   class="form-control"  path="joballowcalid" value="{{did.allowanceid}}" ></form:hidden>
                                        </div>

                                        <div class="form-group">
                                        <form:hidden  class="form-control" value="{{did.allowanceid}}" path="allowanceid"></form:hidden>
                                        </div>

                                        <div class="form-group">
                                        <form:input type="text" class="form-control"  path="allowancehead" value="{{did.allowancehead}}" required="true"></form:input>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <table class="table table-striped table-responsive animated fadeInDown delay-05s">
                                        <thead>
                                            <tr scope="row">
                                                ...
                                                <th style="width: 15%">Allowance Head</th>
                                                <th style="width: 7%">Basic salary</th>
                                                <th style="width: 7%">Percent</th>
                                                <th style="width: 7%">Allowance Amount </th>
                                        ...
                                        <tbody ng-repeat="items in citems">
                                            <tr scope="row" style="margin: 10px">
                                                ...
                                                <td class="h4">{{items.allowanceid}}</td>
                                                <td>{{items.allowancehead}}</td>
                                                <td>Tk.{{items.basicsalary}}</td>
                                                <td>Tk.{{items.percent}}</td>
                                                <td>Tk.{{items.allowpermonth}}</td>
                                                <td><a href="removeallowitem?pid={{items.allowanceid}}"
                    ...
                    <div class="panel-body">
                        <div class="formcontainer ">
                            ...
                            <form:form commandName="payallowcalObject" action="addjoballowcalpage"
                                       enctype="multipart/form-data">
