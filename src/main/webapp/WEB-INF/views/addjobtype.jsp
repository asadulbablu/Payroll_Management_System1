                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Job Type</h4></div>
                                <c:if test="${check}">
                                    <form:form name="addCategoryObject"
                                               modelAttribute="addCategoryObject1" action="addingjobtype"
                                               method="post">
                                        <div class="form-group">
                                            <form:input class="form-control"
                                                        Placeholder="JobType Id" type="text" path="typeid" required="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                            <form:input class="form-control"
                                                        Placeholder="JobType Name" type="text" path="typename" required="true"></form:input>
                                            </div>

                                        <form:button id="editbuttons" type="submit" name="Addcategory"
                                                     class="btn btn-success">Add JobType</form:button>
                                    ...
                                    <form:form name="addCategoryObject"
                                        ...
                                        <div class="form-group">
                                            <form:input id="name" class="form-control"
                                                        Placeholder="JobType Id" type="text" path="typeid" readonly="true"></form:input>
                                            </div>
                                            <div class="form-group">
                                            <form:input id="name" class="form-control"
                                                        Placeholder="JobType Name" type="text" path="typename"></form:input>
                                            </div>

                                        <form:button id="editbuttons" type="submit" name="EditCategory"
                                                     class="btn btn-success">Edit JobType</form:button>
                        ...
                        <div class="chit-chat-layer1">
                            <div class="card-body" >
                                <span class="lead">List Of Job Type</span>
                                <div class="table-responsive"  ng-app="myapp"
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="job in Catagory">

                                                <td>{{job.typeid}}</td>
                                                <td>{{job.typename}}</td>
                                                <td><a href="editjobtypebutton?getcid={{job.typeid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removejobtype/{{job.typeid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
