                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                              <div class="pagetitle" align="center"><h4>Employee Information Report</h4></div>
                                <div class="inner-block">
                                    <form:form method="POST" action="reportView2" commandName="report2InputForm">

                                        <table id="reptbl" width="350px" border="1">

                                            <div class="form-group">
                                                <div class="form-label-group">
                                                    <form:input class="form-control"  type="text" path="empid" required="true" id="empid"></form:input>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-label-group">
                                                    <form:input class="form-control"  type="text" path="empname" required="true" id="empname"></form:input>
                                                        <label for="empname">Emp_Name</label>
                                                    </div>
                                                </div>


                                            <form:button  type="submit"  class="btn btn-success">Search-Employee</form:button>
