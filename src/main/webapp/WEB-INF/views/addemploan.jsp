...
<html>
    <head>
        <title>Employee Loan Page</title>
    ...
    <body ng-app="organocartpackage" ng-controller="ProductController">	
                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="formcontainer">
                                <div class="pagetitle" align="center"><h4>Add Employee Loan</h4></div>
                                <form:form commandName="emploanObject" action="addingemploan"
                                           enctype="multipart/form-data">
                                    <c:if test="${check}">
                                        <div class="form-group">

                                            <form:input class="form-control" Placeholder="EmpLoan Id"
                                                        type="text" path="loanid" required="true"></form:input>
                                            </div>
                                    </c:if>
                                    <c:if test="${!check}">
                                        <div class="form-group">
                                            <form:input class="form-control" Placeholder="EmpLoan Id"
                                                        type="text" path="loanid" readonly="true" required="true"></form:input>
                                            </div>
                                    </c:if>
                                    <div class="form-group">
                                        <form:input class="form-control" Placeholder="Loan Date "
                                                    type="text" path="loandate" required="true"></form:input>
                                        </div>
                                        <div class="form-group">
                                        <form:input type="text" class="form-control"
                                                    placeholder="Matured Date" path="maturedate" required="true"></form:input>
                                        </div>
                                        <div class="form-group">
                                        <form:input class="form-control"
                                                    Placeholder="Loan Amoumt" type="text" path="loanamount" required="true"></form:input>
                                        </div>


                                        <div class="form-group">
                                            <select class="form-control" ng-model="selectedSup" ng-options="x.empname for x in service">
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" ng-model="selectedSup1" ng-options="x.loandescription for x in sss">
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        <form:hidden  class="form-control" value="{{selectedSup1.loantypeid}}" path="loantypeid"></form:hidden>
                                        </div>
                        ...
                        <div class="chit-chat-layer1">
                            <div class="card-body" >
                                <span class="lead">List Of Employee Loan</span>
                                <div width="100%">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="p in loan">
                                                ...
                                                <td><img style="width:10px ;height:20px" src="resources/pimage/{{emp.empid}}.jpg" />
                                                </td>
                                                <td><a href="editemploan?getpid={{p.loanid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removingemploan/{{p.loanid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
        ...
        <script>
    $(document).ready(function () {
    var date_input = $('input[name="loandate"]'); //our date input has the name "date"
    ...
    format: 'yyyy/mm/dd',
            ...
            $(document).ready(function () {
    var date_input = $('input[name="maturedate"]'); //our date input has the name "date"
    var container = $('.bootstrap-iso form').length > 0 ? $('.bootstrap-iso form').parent() : "body";
    date_input.datepicker({
    format: 'yyyy/mm/dd',
            container: container,
